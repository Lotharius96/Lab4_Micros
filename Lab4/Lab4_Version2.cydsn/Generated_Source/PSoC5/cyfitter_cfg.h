...
extern void ADC1_AMux_Set(uint8 channel);
extern void ADC1_AMux_Unset(uint8 channel);
/* ADC1_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE ADC1_AMux__addrTable[2];
/* ADC1_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE ADC1_AMux__maskTable[2];
